...
export function CommodityBars() {
  return (
    <AdminCard className="min-w-0 px-[18px] py-3.5">
      <div className="mb-3.5 text-[11px] font-bold uppercase tracking-[0.1em] text-soil">
        ...
        {COMMODITY_PROFIT_BARS.map((b) => (
          <div key={b.name}>
            <div className="mb-1 flex justify-between gap-2.5 text-[12.5px]">
              <span className="min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-soil">
                {b.name}
              </span>
              <Mono className="flex-none whitespace-nowrap font-semibold text-ink">
                {b.value}
              </Mono>
            </div>
            <div className="h-2 overflow-hidden rounded-full bg-soil/10">
              <div
